...
const JantungQ7 = () => {
    useEffect(() => {
        ...
        if (sessionStorage.getItem("q7_cholesterol")) {
            cholesterolInput.value = sessionStorage.getItem("q7_cholesterol");
        }

        // Save input value when it changes
        const saveCholesterol = () => {
            sessionStorage.setItem("q7_cholesterol", cholesterolInput.value);
        };
