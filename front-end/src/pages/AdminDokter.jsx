...
export default function AdminDokter() {
    ...
    const fetchMedics = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/admin/medicsDetail`, {
                method: "GET",
                credentials: "include"
            });
    ...
    const handleDeleteMedic = async (email) => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/admin/changeToUser`, {
                method: "PUT",
                headers: {
