...
const JantungQ4 = () => {
    useEffect(() => {
        ...
        const savedAnswer = sessionStorage.getItem('q4_answer');
        if (savedAnswer) {
        ...
        const handleOptionClick = function () {
            ...
            sessionStorage.setItem('q4_answer', this.getAttribute('data-value'));
        };
        ...
        const validateAndProceed = (e) => {
            if (!sessionStorage.getItem('q4_answer')) {
                e.preventDefault();
        ...
        <div className="container">
            ...
            <main>
                <div className="suicide-predict-container">
                    ...
                    <div className="progress-text">Pertanyaan ke 4/9</div>

                    <div className="predict-content">
                        <div className="question-container">
                            <h2 className="question">Apakah kamu merokok</h2>

                            <div className="answer-options">
                                <div className="option" data-value="yes">Iya</div>
                                <div className="option" data-value="no">Tidak</div>
                            </div>
                        </div>

                        <div className="nav-buttons">
                            <Link to="/JantungQ3" className="prev-btn">
                                <img src={LeftArrow} alt="Previous" />
                            </Link>
                            <Link to="/JantungQ5" className="next-btn">
