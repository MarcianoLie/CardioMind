...
const JantungQ5 = () => {
  useEffect(() => {
    ...
    if (sessionStorage.getItem("systolic")) {
      systolicInput.value = sessionStorage.getItem("systolic");
    }
    if (sessionStorage.getItem("diastolic")) {
      diastolicInput.value = sessionStorage.getItem("diastolic");
    }

    // Save input values when they change
    const saveSystolic = () => {
      sessionStorage.setItem("systolic", systolicInput.value);
    };
    const saveDiastolic = () => {
      sessionStorage.setItem("diastolic", diastolicInput.value);
    };
