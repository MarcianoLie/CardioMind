...
export default function AdminUser() {
    ...
    const fetchUsers = async () => {
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/api/admin/usersDetail`, {
                method: "GET",
                credentials: "include"
            });
    ...
    const handleDeleteUser = async (email) => {
        ...
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/api/admin/delete-user`, {
                method: "DELETE",
                headers: {
    ...
    const fetchMedicUsers = async () => {
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/api/admin/list-medic`, {
                method: "GET",
                credentials: "include",
            });
    ...
    const handleEmailSearch = async () => {
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/api/admin/search-user?email=${searchEmail}`, {
                method: "GET",
                credentials: "include",
            });
    ...
    const handlePromoteToMedic = async () => {
        ...
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/api/admin/promote-to-medic`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
