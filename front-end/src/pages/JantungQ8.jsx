...
const JantungQ8 = () => {
  useEffect(() => {
    ...
    const savedAnswer = sessionStorage.getItem("active");
    if (savedAnswer) {
    ...
    const handleOptionClick = function () {
      ...
      sessionStorage.setItem("active", this.getAttribute("data-value"));
    };
    ...
    <div className="container">
      ...
      <main>
        <div className="suicide-predict-container">
          ...
          <div className="progress-text">Pertanyaan ke 8/9</div>

          <div className="predict-content">
            <div className="question-container">
              <h2 className="question">
                Apakah Anda aktif secara fisik dalam keseharian Anda? (berjalan
                kaki, naik tangga, atau pekerjaan fisik)
              </h2>
            ...
            <div className="nav-buttons">
              ...
              <Link to="/JantungQ9" className="next-btn">
